...
shared a way to
[analyze cryptocurrency price trends in real-time](/blog/realtime-crypto-tracker-with-questdb-kafka-connector/)
...
[the Kafka project](/blog/realtime-crypto-tracker-with-questdb-kafka-connector/),
