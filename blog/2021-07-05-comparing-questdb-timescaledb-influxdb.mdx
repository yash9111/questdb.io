...
In terms of performance, QuestDB also outperformed other TSDBs. The
high-cardinality Time Series Benchmark Suite results use the `cpu-only` use case
with 6 to 16 workers on 32 CPUs and 64GB RAM:
