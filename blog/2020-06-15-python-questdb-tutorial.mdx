---
title: Building an Interactive Plot Using Jupyter Notebooks
...
slug: building-interactive-plot-using-jupyter-notebooks
---
...
Jupyter Notebook to create an interactive environment. We will use this
environment to generate a database, execute queries, import contents into a
Pandas DataFrame, and finally, use `matplotlib` to visualize the data.

## Install QuestDB and Jupyter Notebooks

You'll need a few things installed and set up to get started.

- QuestDB: [Install QuestDB](/docs/#get-started).

- Jupyter Notebooks: These interactive Python environments will help you run a
  complete version of this tutorial.

To run it, you should:

- install Jupyter Notebooks
- make sure that the libraries we use in this tutorial are also installed:
...
- clone [this repository](https://github.com/questdb/QuestNotebook)
(`git clone https://github.com/questdb/QuestNotebook`) in the repository
...
## Using the Jupyter Notebook to create, refine, and plot data

### Create a database in QuestDB
...
### Generate and query data in QuestDB
...
### Export the content into Pandas DataFrame
...
## More QuestDB with Jupyter Notebooks

We also built a project, [`play`](https://play.questdb.io/), for anyone to try
our database with a Jupyter Notebook, data, sample code, queries, and graphs.
