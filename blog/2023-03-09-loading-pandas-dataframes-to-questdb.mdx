...
description:
  Learn how to improve your time series analysis capability by using the QuestDB
  Python package to ingest Pandas DataFrames.
keywords:
  - timeseries
  - questdb
  - pandas
  ...
  - python
  - database
tags: [tutorial, timeseries, pandas, python, dataframes, questdb]
image: "/img/blog/2023-03-09/banner.png"
slug: laoding-pandas-dataframes
---
...
available memory of the machine it is running on. This is where QuestDB excels,
designed specifically for high-performance operations in such
scenarios, making it the go-to solution for demanding data analysis tasks. By
loading Pandas DataFrames into QuestDB, we can leverage
...
of the database, allowing you to scale your analysis and data manipulation
operations to large datasets. We will learn how to load large
Pandas dataframes into QuestDB. We use yellow and green taxi trip records
published by NYC Taxi & Limousine Commission as our data source.
...
Now, we have the data to ingest. It is time to try loading it using Pandas.
...
Right, we have an Ubuntu-based Python 3.11 docker container. Let’s install our
...
Now, execute it within the docker container by running `python data_loader.py`.
...
We just loaded the taxi trip records for 2022 January! Let’s try to load more
