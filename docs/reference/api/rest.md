...
more in the section [using the Web Console](/docs/connect/web-console).
...
| `commitLag`          | No       | `0`              | commit lag of the import in microsecond precision (e.g. 2 minutes is expressed as 120000000, 120 followed by 6 zeros). For context, see [the commit lag guide](/docs/how-do-i/ingest-data-out-of-order).                                                          |
...
| `maxUncommittedRows` | No       | 0                | The maximum number of uncommitted rows to keep in memory before triggering a sort and commit operation. For context, see [the commit lag guide](/docs/how-do-i/ingest-data-out-of-order).                                                                         |
...
parameters, see [the commit lag guide](/docs/how-do-i/ingest-data-out-of-order).
