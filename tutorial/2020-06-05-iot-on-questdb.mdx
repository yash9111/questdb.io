...
[Docker](/docs/install/docker/) image for those who want to run without
installing any dependencies, a [Homebrew](/docs/install/homebrew/) install
with `brew install questdb`, grabbing the
[binaries](/docs/install/binaries/) directly, and building from source.
...
![Terminal showing QuestDB being build from its source code](/img/tutorial/2020-06-05/build.gif)
...
![Terminal showing how to start QuestDB](/img/tutorial/2020-06-05/start.gif)
...
![Electrical schema showing how the sensor is wired](/img/tutorial/2020-06-05/sensor.png)
...
![Running a SELECT query on the Web Console. The result is in both a table and a chart](/img/tutorial/2020-06-05/queries.gif)
