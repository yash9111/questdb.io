...
started with [Docker](/docs/install/docker/),
[Homebrew](/docs/install/homebrew/) on macOS, or the
[binaries](/docs/install/binaries/).
...
![Graph of the balance from the query](/img/tutorial/2020-06-15/graph.png)
